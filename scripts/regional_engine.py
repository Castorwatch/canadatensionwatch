...
# ============================================
SOURCE_LOADERS = [
    {"id": "chomage",   "loader": signal_chomage,  "poids": 0.40, "geo": "province"},
    {"id": "vol_auto",  "loader": signal_vol_auto, "poids": 0.30, "geo": "province"},
    {"id": "reventes",  "loader": signal_reventes, "poids": 0.30, "geo": "ville"},
    # ÉTAPES FUTURES (plan) — décommenter quand le scraper existe :
    # {"id": "faillites",  "loader": signal_faillites,  "poids": ?, "geo": "province"},
